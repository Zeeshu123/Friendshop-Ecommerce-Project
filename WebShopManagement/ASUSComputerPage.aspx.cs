...
{
    public partial class ASUSComputerPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputerProducts();
        }
        void load_products5000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer5000Products();
        }

        void load_products10000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer10000Products();
        }

        void load_products20000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer20000Products();
        }

        void load_products30000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer30000Products();
        }

        void load_products50000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer20000_HighestProducts();
        }
        ...
        {
            products_list = objComputerSetup_BLL.GetAllASUSComputer30000_HighestProducts();
        }
