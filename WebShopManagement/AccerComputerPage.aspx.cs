...
{
    public partial class AccerComputerPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputerProducts();
        }
        void load_products5000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer5000Products();
        }

        void load_products10000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer10000Products();
        }

        void load_products20000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer20000Products();
        }

        void load_products30000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer30000Products();
        }

        void load_products50000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer20000_HighestProducts();
        }
        ...
        {
            products_list = objComputerSetup_BLL.GetAllACCERComputer30000_HighestProducts();
        }
