...
{
    public partial class EasyPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllEASYProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllEASY500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllEASY1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllEASY2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllEASY3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllEASY500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllEASY500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllEASY500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllEASY500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllEASY1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllEASY1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllEASY1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllEASY1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllEASY1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllEASY1500_HighestProducts();
        }
