<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="HPComputerPage.aspx.cs" Inherits="WebShopManagement.HPComputerPage" %>
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                ...
                                <a href="HPComputerPage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
