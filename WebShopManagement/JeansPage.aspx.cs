...
namespace WebShopManagement.Search_Pages
{
    public partial class JeansPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllJeansProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllJeans500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllJeans1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllJeans2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllJeans3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllJeans500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllJeans500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllJeans500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllJeans500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllJeans1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllJeans1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllJeans1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllJeans1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllJeans1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllJeans1500_HighestProducts();
        }
