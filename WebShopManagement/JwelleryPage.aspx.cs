...
{
    public partial class JwelleryPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwelleryProducts();
        }

        void load_products500()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery500Products();
        }

        void load_products1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1000Products();
        }

        void load_products2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery2000Products();
        }

        void load_products3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery3000Products();
        }
        void load_products500_1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenJwellery1500_HighestProducts();
        }
