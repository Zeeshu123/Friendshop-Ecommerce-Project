...
{
    public partial class MenShoePage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOEProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllMenSHOE1500_HighestProducts();
        }
