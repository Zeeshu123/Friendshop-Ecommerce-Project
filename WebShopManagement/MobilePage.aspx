<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="MobilePage.aspx.cs" Inherits="WebShopManagement.Pages.MobilePage" %>
     ...
     <div class="banner">
        <div class="col-sm-3">
            <div style="margin-left: 80px">
                ...
                <a href="OppoPage.aspx" style="margin-left:20px;"> >>  Oppo</a><br />
                <a href="SymphonyPage.aspx" style="margin-left:20px;"> >>  Symphony</a><br />
                <a href="SamsungPage.aspx" style="margin-left:20px;"> >>  Samsung</a>
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                ...
                                <a href="MobilePage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
