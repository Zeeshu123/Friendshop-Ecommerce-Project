...
namespace WebShopManagement.Pages
{
    public partial class MobilePage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllMobileProducts();
        }

        void load_products2000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000Products();
        }

        void load_products3000()
        {
            products_list = objProductSetup_BLL.GetAllMobile3000Products();
        }

        void load_products5000()
        {
            products_list = objProductSetup_BLL.GetAllMobile5000Products();
        }

        void load_products10000()
        {
            products_list = objProductSetup_BLL.GetAllMobile10000Products();
        }
        void load_products20000()
        {
            products_list = objProductSetup_BLL.GetAllMobile20000Products();
        }
        void load_products30000()
        {
            products_list = objProductSetup_BLL.GetAllMobile30000Products();
        }
        void load_products2000_3000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_3000Products();
        }
        void load_products2000_5000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_5000Products();
        }
        void load_products2000_10000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_10000Products();
        }

        void load_products2000_20000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_20000Products();
        }

        void load_products2000_30000()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_30000Products();
        }

        void load_products5000_10000()
        {
            products_list = objProductSetup_BLL.GetAllMobile5000_10000Products();
        }

        void load_products5000_20000()
        {
            products_list = objProductSetup_BLL.GetAllMobile5000_20000Products();
        }

        void load_products5000_30000()
        {
            products_list = objProductSetup_BLL.GetAllMobile5000_30000Products();
        }

        void load_products10000_20000()
        {
            products_list = objProductSetup_BLL.GetAllMobile10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objProductSetup_BLL.GetAllMobile10000_30000Products();
        }

        void load_products20000_30000()
        {
            products_list = objProductSetup_BLL.GetAllMobile20000_30000Products();
        }

        void load_products2000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllMobile2000_Highest_Price();
        }

        void load_products5000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllMobile5000_Highest_Price();
        }

        void load_products10000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllMobile10000_Highest_Price();
        }

        void load_products20000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllMobile20000_Highest_Price();
        }
