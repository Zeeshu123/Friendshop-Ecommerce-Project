<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="OtherComputerPage.aspx.cs" Inherits="WebShopManagement.OtherComputerPage" %>
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                ...
                                <a href="OtherComputerPage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
