...
{
    public partial class OtherComputerPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputerProducts();
        }
        void load_products5000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer5000Products();
        }

        void load_products10000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer10000Products();
        }

        void load_products20000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer20000Products();
        }

        void load_products30000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer30000Products();
        }

        void load_products50000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer20000_HighestProducts();
        }
        ...
        {
            products_list = objComputerSetup_BLL.GetAllOthersComputer30000_HighestProducts();
        }
