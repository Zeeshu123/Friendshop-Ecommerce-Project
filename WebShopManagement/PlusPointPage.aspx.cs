...
{
    public partial class PlusPointPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllPlusPointProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPlusPoint1500_HighestProducts();
        }
