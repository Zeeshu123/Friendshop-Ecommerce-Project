...
{
    public partial class REXPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllREXProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllREX500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllREX1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllREX2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllREX3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllREX500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllREX500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllREX500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllREX500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllREX1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllREX1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllREX1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllREX1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllREX1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllREX1500_HighestProducts();
        }
