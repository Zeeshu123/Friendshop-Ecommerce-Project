...
{
    public partial class SONYCoputerPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputerProducts();
        }
        void load_products5000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer5000Products();
        }

        void load_products10000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer10000Products();
        }
        ...
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer30000Products();
        }

        void load_products50000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer20000_HighestProducts();
        }
        ...
        {
            products_list = objComputerSetup_BLL.GetAllSONYComputer30000_HighestProducts();
        }
