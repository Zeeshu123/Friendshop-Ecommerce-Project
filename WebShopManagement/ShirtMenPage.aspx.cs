...
{
    public partial class ShirtMenPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllshirtProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllshirt500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllshirt1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllshirt2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllshirt3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllshirt500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllshirt500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllshirt500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllshirt500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllshirt1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllshirt1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllshirt1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllshirt1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllshirt1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllshirt1500_HighestProducts();
        }
