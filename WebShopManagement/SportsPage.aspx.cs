...
{
    public partial class SportsPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllSportProducts();
        }

        void load_products500()
        {
            products_list = objProductSetup_BLL.GetAllSport500Products();
        }

        void load_products1000()
        {
            products_list = objProductSetup_BLL.GetAllSport1000Products();
        }

        void load_products2000()
        {
            products_list = objProductSetup_BLL.GetAllSport2000Products();
        }

        void load_products3000()
        {
            products_list = objProductSetup_BLL.GetAllSport3000Products();
        }
        void load_products500_1000()
        {
            products_list = objProductSetup_BLL.GetAllSport500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objProductSetup_BLL.GetAllSport500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objProductSetup_BLL.GetAllSport500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllSport500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objProductSetup_BLL.GetAllSport1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objProductSetup_BLL.GetAllSport1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllSport1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objProductSetup_BLL.GetAllSport1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objProductSetup_BLL.GetAllSport1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllSport1500_HighestProducts();
        }
