...
{
    public partial class SymphonyPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobileProducts();
        }

        void load_products2000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000Products();
        }

        void load_products3000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile3000Products();
        }

        void load_products5000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile5000Products();
        }

        void load_products10000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile10000Products();
        }
        void load_products20000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile20000Products();
        }
        void load_products30000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile30000Products();
        }
        void load_products2000_3000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_3000Products();
        }
        void load_products2000_5000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_5000Products();
        }
        void load_products2000_10000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_10000Products();
        }

        void load_products2000_20000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_20000Products();
        }

        void load_products2000_30000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_30000Products();
        }

        void load_products5000_10000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile5000_10000Products();
        }

        void load_products5000_20000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile5000_20000Products();
        }

        void load_products5000_30000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile5000_30000Products();
        }

        void load_products10000_20000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile10000_30000Products();
        }

        void load_products20000_30000()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile20000_30000Products();
        }

        void load_products2000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile2000_Highest_Price();
        }

        void load_products5000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile5000_Highest_Price();
        }

        void load_products10000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile10000_Highest_Price();
        }

        void load_products20000_Highest_Price()
        {
            products_list = objProductSetup_BLL.GetAllSymphonyMobile20000_Highest_Price();
        }
