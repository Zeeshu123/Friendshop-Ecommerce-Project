...
{
    public partial class Tv_Camera : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllTVCameraProducts();
        }
        void load_products10000()
        {
            products_list = objProductSetup_BLL.GetAllTV10000Products();
        }

        void load_products20000()
        {
            products_list = objProductSetup_BLL.GetAllTV20000Products();
        }

        void load_products30000()
        {
            products_list = objProductSetup_BLL.GetAllTV30000Products();
        }

        void load_products50000()
        {
            products_list = objProductSetup_BLL.GetAllTV50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objProductSetup_BLL.GetAllTV10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objProductSetup_BLL.GetAllTV10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objProductSetup_BLL.GetAllTV10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllTV10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objProductSetup_BLL.GetAllTV20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objProductSetup_BLL.GetAllTV20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllTV20000_HighestProducts();
        }
        ...
        {
            products_list = objProductSetup_BLL.GetAllTV30000_HighestProducts();
        }
