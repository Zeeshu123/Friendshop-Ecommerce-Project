...
{
    public partial class WomenBataPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoeProducts();
        }

        void load_products500()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe500Products();
        }

        void load_products1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1000Products();
        }

        void load_products2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe2000Products();
        }

        void load_products3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe3000Products();
        }
        void load_products500_1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenBataShoe1500_HighestProducts();
        }
