...
{
    public partial class WomenShoePage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoeProducts();
        }

        void load_products500()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe500Products();
        }

        void load_products1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1000Products();
        }

        void load_products2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe2000Products();
        }

        void load_products3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe3000Products();
        }
        void load_products500_1000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objWomenSetup_BLL.GetAllWomenShoe1500_HighestProducts();
        }
