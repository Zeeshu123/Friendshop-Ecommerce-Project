<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="beautyhealthPage.aspx.cs" Inherits="WebShopManagement.beautyhealthPage" %>
    ...
    <div class="banner">
        <div class="col-sm-3">
            <div style="margin-left: 80px">
                ...
                <a href="WomenPage.aspx" style="margin-left:20px;"> >> WOMEN'S FASHION</a><br />
                <a href="#" style="margin-left:20px;"> >> GIFT</a><br />
                <a href="#" style="margin-left:20px;"> >> FLOWERS</a><br />
                <a href="#" style="margin-left:20px;"> >> BABY,KIDS & TOYS</a><br />
                <a href="#" style="margin-left:20px;"> >> BEAUTY & HEALTH</a><br />
                <a href="#" style="margin-left:20px;"> >> BEAUTY & HEALTH</a>
            </div>
        </div>
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                ...
                                <a href="beautyhealthPage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
