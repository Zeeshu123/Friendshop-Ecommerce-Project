...
{
    public partial class beautyhealthPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllBeautyProducts();
        }

        void load_products500()
        {
            products_list = objProductSetup_BLL.GetAllBeauty500Products();
        }

        void load_products1000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1000Products();
        }

        void load_products2000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty2000Products();
        }

        void load_products3000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty3000Products();
        }
        void load_products500_1000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllBeauty500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllBeauty1500_HighestProducts();
        }
