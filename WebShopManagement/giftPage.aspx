<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="giftPage.aspx.cs" Inherits="WebShopManagement.giftPage" %>
    ...
    <div class="banner">
        <div class="col-sm-3">
            <div style="margin-left: 80px">
                ...
                <a href="MenPage.aspx" style="margin-left:20px;"> >> MEN'S FASHION</a><br />
                <a href="WomenPage.aspx" style="margin-left:20px;"> >> WOMEN'S FASHION</a><br />
                <a href="MobilePage.aspx" style="margin-left:20px;"> >> PHONES & TABLETS</a><br />
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                ...
                                <a href="giftPage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
