...
{
    public partial class giftPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllGiftProducts();
        }

        void load_products500()
        {
            products_list = objProductSetup_BLL.GetAllGift500Products();
        }

        void load_products1000()
        {
            products_list = objProductSetup_BLL.GetAllGift1000Products();
        }

        void load_products2000()
        {
            products_list = objProductSetup_BLL.GetAllGift2000Products();
        }

        void load_products3000()
        {
            products_list = objProductSetup_BLL.GetAllGift3000Products();
        }
        void load_products500_1000()
        {
            products_list = objProductSetup_BLL.GetAllGift500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objProductSetup_BLL.GetAllGift500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objProductSetup_BLL.GetAllGift500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllGift500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objProductSetup_BLL.GetAllGift1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objProductSetup_BLL.GetAllGift1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllGift1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objProductSetup_BLL.GetAllGift1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objProductSetup_BLL.GetAllGift1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objProductSetup_BLL.GetAllGift1500_HighestProducts();
        }
