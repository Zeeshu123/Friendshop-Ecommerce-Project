<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="homelivingPage.aspx.cs" Inherits="WebShopManagement.homelivingPage" %>
    ...
    <div class="banner">
        <div class="col-sm-3">
            <div style="margin-left: 80px">
                ...
                <a href="Appliences.aspx" style="margin-left:20px;"> >> Appliances</a><br />    
                <a href="TvCamera.aspx" style="margin-left:20px;"> >> TV & Audio</a><br />            
            </div>
        </div>
                ...
                <div class="content-top1">
                    ...
                    <div class="col-md-3 col-md-2">
                        <div class="col-md1 simpleCart_shelfItem">
                            ...
                            <div class="price">
                                <h5 class="item_price">  Tk.<%=Convert.ToInt32(product.Sell_Rate)%></h5>
                                <a href="homelivingPage.aspx?pro_id=<%=product.Product_Id %>&action=add" class="item_add">Add To Cart</a>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
