...
{
    public partial class homelivingPage : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objProductSetup_BLL.GetAllHomeLivingProducts();
        }

        void load_products10000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving10000Products();
        }

        void load_products20000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving20000Products();
        }

        void load_products30000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving30000Products();
        }

        void load_products50000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving50000Products();
        }

        void load_products10000_20000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving10000_20000Products();
        }

        void load_products10000_30000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving10000_30000Products();
        }

        void load_products10000_50000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving10000_50000Products();
        }

        void load_products10000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving10000_HighestProducts();
        }

        void load_products20000_30000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving20000_30000Products();
        }

        void load_products20000_50000()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving20000_50000Products();
        }

        void load_products20000_Highest()
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving20000_HighestProducts();
        }
        ...
        {
            products_list = objProductSetup_BLL.GetAllHomeLiving30000_HighestProducts();
        }
