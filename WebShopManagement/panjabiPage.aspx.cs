...
{
    public partial class panjabi : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllPanjabiProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllPanjabi1500_HighestProducts();
        }
