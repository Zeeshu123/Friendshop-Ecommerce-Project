...
namespace WebShopManagement
{
    public partial class tShirt : System.Web.UI.Page
    {
        ...
        void load_products()
        {
            products_list = objMenSetup_BLL.GetAllTshirtProducts();
        }

        void load_products500()
        {
            products_list = objMenSetup_BLL.GetAllTshirt500Products();
        }

        void load_products1000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1000Products();
        }

        void load_products2000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt2000Products();
        }

        void load_products3000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt3000Products();
        }
        void load_products500_1000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt500_1000Products();
        }
        void load_products500_2000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt500_2000Products();
        }
        void load_products500_3000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt500_3000Products();
        }

        void load_products500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllTshirt500_HighestProducts();
        }

        void load_products1000_2000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1000_2000Products();
        }

        void load_products1000_3000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1000_3000Products();
        }

        void load_products1000_Highest()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1000_HighestProducts();
        }

        void load_products1500_2000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1500_2000Products();
        }

        void load_products1500_3000()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1500_3000Products();
        }

        void load_products1500_Highest()
        {
            products_list = objMenSetup_BLL.GetAllTshirt1500_HighestProducts();
        }
